...
public class UfoGame extends GraphicsProgram {
	...
	/** when space is pressed it will pause the game
	 * until the space is pressed again to resume.
	 * this is my addition
	 */
	...
	/** move UFO, if UFO has moved to edge of screen, moves
	 ...
	 * if it has, remove bullet, sets variable to null
	 */
	...
	private boolean ufoToLeft; // when true, UFO is moving to the left
